...
#add_arg('audio_path1',      str,    'audio/chunk3.wav',          '预测第一个音频')
#add_arg('audio_path2',      str,    'audio/chunk4.wav',          '预测第二个音频')
add_arg('threshold',        float,   0.75,                    '判断是否为同一个人的阈值')#0.71#0.750000
add_arg('input_shape',      str,    '(1, 257, 257)',          '数据输入的形状')
add_arg('model_path',       str,    'models/resnet34.pth',    '预测模型的路径')
#add_arg('model_path',       str,    'models/example50_num10.pth',    '预测模型的路径')
