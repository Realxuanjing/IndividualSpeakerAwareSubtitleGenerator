...
# 加载并预处理音频
def load_audio(audio_path, mode='train', win_length=400, sr=16000, hop_length=160, n_fft=512, spec_len=257, pan=False):  # 257
    # 读取音频数据
    ...
    #修改
    if (freq_time < spec_len):
        spec_len = 80
    if(pan):
        spec_len = freq_time-30
    print("freq_time is", freq_time)
    print("spec_len is", spec_len)
